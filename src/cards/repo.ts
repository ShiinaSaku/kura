...
import { flexLayout, measureText, iconWithLabel, createLanguageNode } from "../common/render";
 ...
 */
const renderRepoCard = (repo: RepositoryData, options: Partial<RepoCardOptions> = {}): string => {
  const {
    name,
    nameWithOwner,
    description,
