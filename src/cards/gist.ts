import { measureText, flexLayout, iconWithLabel, createLanguageNode } from "../common/render";
 ...
 */
const renderGistCard = (gistData: GistData, options: Partial<GistCardOptions> = {}): string => {
